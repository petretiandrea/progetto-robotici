...
//
#include <cmath>
#include_next <argos3/core/utility/math/vector3.h>
...
namespace constants {
    ...
    extern const float PROXIMITY_SIGHT = 1.5f; // threshold or sight of proximity sensor (8 virtual sensor from 24 => 3.0 is the value)
    ...
    extern const int N_TRIAL = 5; // number of experiment for each individual
